...
call s:hi("StatusLine", s:my_gray_dark, s:bg_light, "NONE", "NONE")
...
call s:hi("StatusLineTerm", s:my_gray_dark, s:bg_light, "NONE", "NONE")
...
call s:hi("PmenuSel", s:my_gray_dark, s:my_yellow_light, "NONE", "NONE")
...
" Неактивные вкладки
call s:hi("TabLine", s:my_gray_dark, s:bg_light, "NONE", "NONE")
" Фон линии вкладок
call s:hi("TabLineFill", "NONE", s:bg_light, "NONE", "NONE")
" Активная вкладка
call s:hi("TabLineSel", s:my_gray_dark, s:my_yellow_light, "NONE", "NONE")

" === Панели инструментов ===
" Фон панели инструментов
call s:hi("ToolbarLine", "NONE", s:my_gray, "NONE", "NONE")
" Кнопки на панели инструментов
call s:hi("ToolbarButton", s:my_gray_dark, s:my_gold, "bold", "bold")
...
call s:hi("QuickFixLine", s:my_gray_dark, s:my_yellow_light, "NONE", "NONE")
...
call s:hi("WildMenu", s:my_gray_dark, s:my_yellow, "NONE", "NONE")
...
" === Курсоры ===
" Основной курсор
call s:hi("Cursor", s:my_gray_dark, s:my_yellow_light, "NONE", "NONE")
" Локализованный курсор
call s:hi("lCursor", s:my_gray_dark, s:my_red, "NONE", "NONE")
